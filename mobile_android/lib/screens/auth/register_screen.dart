          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 32),
                // Ad
                const Text('Ad', style: TextStyle(color: Colors.black54, fontSize: 13)),
                const SizedBox(height: 8),
                TextFormField(
                ...
                const SizedBox(height: 20),
                // Soyad
                const Text('Soyad', style: TextStyle(color: Colors.black54, fontSize: 13)),
                const SizedBox(height: 8),
                TextFormField(
                ...
                const SizedBox(height: 20),
                // Telefon Numarası
                const Text('Telefon Numarası', style: TextStyle(color: Colors.black54, fontSize: 13)),
                const SizedBox(height: 8),
                TextFormField(
                ...
                const SizedBox(height: 20),
                // Şifre Tekrar
                const Text('Şifre Tekrar', style: TextStyle(color: Colors.black54, fontSize: 13)),
                const SizedBox(height: 8),
                TextFormField(
